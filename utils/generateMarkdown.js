...
function renderLicenseBadge(license) {
  ...
  if (license === "None") {
    ...
    badge =
      "[![License: GNU General Public](https://img.shields.io/badge/License-GNU%20General%20Public-blue.svg)]";
    ...
    badge =
      "[![License: BSD-3-Clause](https://img.shields.io/badge/License-BSD%203%20Clause-blue.svg)]";
  } else if (license === "Boost Software License 1.0") {
    badge =
      "[![License: BSL-1](https://img.shields.io/badge/License-BSL%201-blue.svg)]";
    ...
    badge =
      "[![License: AGPL-3.0-only](https://img.shields.io/badge/License-AGPL%203.0%20only-blue.svg)]";
